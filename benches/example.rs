...
pub fn random_json_data(unit_length: usize, unit_count: usize, record_count: usize) -> String {
...
fn bench_example(c: &mut Criterion){
    ...
    let json_data = random_json_data(unit_length, unit_count, record_count);
