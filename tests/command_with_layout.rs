...
fn command_with_layout_0() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_STYLE_SYMBOLS_FILES_AND_LAYOUT_0);
}
...
fn command_with_layout_1() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_STYLE_SYMBOLS_FILES_AND_LAYOUT_1);
}
...
fn command_with_layout_2() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_STYLE_SYMBOLS_FILES_AND_LAYOUT_2);
}
...
fn command_with_layout_units() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_STYLE_SYMBOLS_FILES_AND_LAYOUT_UNITS);
}
...
fn command_with_layout_groups() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_STYLE_SYMBOLS_FILES_AND_LAYOUT_GROUPS);
}
