...
fn command_with_style_symbols() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_FILES_STYLE_SYMBOLS_LAYOUT_RECORDS);
}
...
fn command_with_style_controls() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_FILES_STYLE_CONTROLS_LAYOUT_RECORDS);
}
...
fn command_with_style_braces() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_FILES_STYLE_BRACES_LAYOUT_RECORDS);
}
