...
fn command_with_style_controls() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_STYLE_CONTROLS_FILES_AND_LAYOUT_RECORDS);
}
...
fn command_with_style_braces() {
    ...
    assert_eq!(actual, usv::examples::EXAMPLE_STYLE_BRACES_FILES_AND_LAYOUT_RECORDS);
}
